...
static const _ObjectCentroids_type_support_symbol_names_t _ObjectCentroids_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robovision_interfaces, msg, ObjectCentroids)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robovision_interfaces, msg, ObjectCentroids)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robovision_interfaces, msg, ObjectCentroids)() {
  return &::robovision_interfaces::msg::rosidl_typesupport_c::ObjectCentroids_message_type_support_handle;
}
