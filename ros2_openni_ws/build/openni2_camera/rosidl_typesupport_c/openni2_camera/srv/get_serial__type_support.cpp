...
static const _GetSerial_Event_type_support_symbol_names_t _GetSerial_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, openni2_camera, srv, GetSerial_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openni2_camera, srv, GetSerial_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, openni2_camera, srv, GetSerial_Event)() {
  return &::openni2_camera::srv::rosidl_typesupport_c::GetSerial_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetSerial_service_type_support_handle = {
  ...
  &GetSerial_Request_message_type_support_handle,
  &GetSerial_Response_message_type_support_handle,
  &GetSerial_Event_message_type_support_handle,
