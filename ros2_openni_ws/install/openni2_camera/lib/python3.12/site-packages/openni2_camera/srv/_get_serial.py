...
class Metaclass_GetSerial_Event(type):
    """Metaclass of message 'GetSerial_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_serial__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_serial__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_serial__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_serial__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_serial__event
...
class GetSerial_Event(metaclass=Metaclass_GetSerial_Event):
    """Message class 'GetSerial_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<openni2_camera/GetSerial_Request, 1>',
        'response': 'sequence<openni2_camera/GetSerial_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['openni2_camera', 'srv'], 'GetSerial_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['openni2_camera', 'srv'], 'GetSerial_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from openni2_camera.srv import GetSerial_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetSerial_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetSerial_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from openni2_camera.srv import GetSerial_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetSerial_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetSerial_Response'"
...
class Metaclass_GetSerial(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_serial.Metaclass_GetSerial_Event._TYPE_SUPPORT is None:
                _get_serial.Metaclass_GetSerial_Event.__import_type_support__()
...
class GetSerial(metaclass=Metaclass_GetSerial):
    ...
    from openni2_camera.srv._get_serial import GetSerial_Event as Event
